...
class QSc02 extends StatefulWidget {
  @override
  _QuizScreenState createState() => _QuizScreenState();
}

class _QuizScreenState extends State<QSc02> {
  int currentQuestionIndex = 0;
  int correctAnswers = 0; // เพิ่มตัวแปรเก็บคะแนน

  List<Map<String, dynamic>> questions = [
    {
      "question": "1.อะตอมของธาตุไฮโดรเจนมีโครงสร้างเป็นอย่างไร?",
      "options": [" โปรตอน ", " อิเล็กตรอน ", " โน่ตรอน ", " ปรอทรอน "],
      "correctAnswer": 0
    },
    {
      "question": "2.โครงสร้างของอะตอมธาตุน้ำตาลมีกี่โปรตอน?",
      "options": [" 1 ", " 2 ", " 3 ", " 4 "],
      "correctAnswer": 3
    },
    {
      "question": "3.อะตอมของธาตุซิลเวอร์มีโครงสร้างเป็นอย่างไร?",
      "options": [" โปรตอน ", " อิเล็กตรอน ", " โน่ตรอน ", " ปรอทรอน "],
      "correctAnswer": 2
    },
    {
      "question": "4.โครงสร้างของอะตอมธาตุออกซิเจนมีกี่โปรตอน",
      "options": [" 6 ", " 7 ", " 8 ", " 9 "],
      "correctAnswer": 2
    },
    {
      "question": "5.อะตอมของธาตุคาร์บอนมีโครงสร้างเป็นอย่างไร",
      "options": [" 3 ", " 4 ", " 3 ", " 6 "],
      "correctAnswer": 3
    },
